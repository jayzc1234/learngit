 ...
 * @author Jiaju Zhuang
 */
public class OrderImportAnalysisEventListener extends AnalysisEventListener<OrderImportExcelHead> {
    private static final Logger LOGGER = LoggerFactory.getLogger(OrderImportAnalysisEventListener.class);
    /**
    ...
    public OrderImportAnalysisEventListener(OrderImportService orderImportService, Date orderDate, Integer importType) {
    ...
    List<OrderImportExcelHead> list = new ArrayList<OrderImportExcelHead>();
    ...
    @Override
    public void invoke(OrderImportExcelHead data, AnalysisContext context) {
