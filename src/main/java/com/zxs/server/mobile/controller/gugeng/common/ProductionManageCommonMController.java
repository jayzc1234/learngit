package com.zxs.server.mobile.controller.gugeng.common;
...
@Slf4j
@RestController
@RequestMapping(VALID_MOBILE_PATH+"/common")
@Api(value = "古耕公共接口模块", tags = "古耕公共接口")
public class ProductionManageCommonMController extends CommonUtil {
	@Autowired
...
//		commonService.orderImport(multipartFile.getInputStream());
	...
	public RestResult test(@RequestBody ClientCategoryDTO clientCategoryDTO) throws SuperCodeException, IOException {
