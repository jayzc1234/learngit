package com.zxs.server.mobile.controller.gugeng.producemanage;
 ...
 */
@RestController
@Api(value = "采收计划app controller", tags = "采收计划app管理")
@RequestMapping(VALID_MOBILE_PATH+"/harvest-plan")
public class ProductionManageHarvestPlanMController {
    ...
    @NeedAdvancedSearch
    @GetMapping("/production-forecast/list")
