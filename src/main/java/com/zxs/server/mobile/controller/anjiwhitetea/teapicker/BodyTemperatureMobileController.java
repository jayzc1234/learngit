package com.zxs.server.mobile.controller.anjiwhitetea.teapicker;
 ...
 */
@RestController
@RequestMapping( VALID_MOBILE_PATH+"/bodyTemperature")
@Api(value = "测量体温", tags = "测量体温")
public class BodyTemperatureMobileController {
