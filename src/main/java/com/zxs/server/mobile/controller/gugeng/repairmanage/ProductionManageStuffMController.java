 ...
 */
@RestController
@RequestMapping(VALID_MOBILE_PATH+"/stuff")
@Api(value = "维护材料", tags = "维护材料")
public class ProductionManageStuffMController extends CommonUtil {
    ...
    public void export(ProductionManageStuffListDTO listDTO, HttpServletResponse response) throws Exception {
        service.exportExcel(listDTO, getExportNumber(), "材料", response);
    }
}
