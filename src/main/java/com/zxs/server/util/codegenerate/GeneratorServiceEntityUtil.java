...
public class GeneratorServiceEntityUtil {
    ...
    private static final String DB_URL = "jdbc:mysql://192.168.2.214:3306/hydra_intelligent_planting?characterEncoding=utf-8&useSSL=false";
    ...
    private static final String UPDATE_TIME = "update_date";
    ...
    public static void main(String[] args) throws SQLException {
        ...
        generateByTables("hydra-intelligent-planting-server",
                new String[]{"t_gu_geng_client_maintain","t_gu_geng_common_type","t_gu_geng_contact_man",
                        "t_gu_geng_plant_stock","t_gu_geng_product_loss","t_gu_geng_visitor_manage","t_gu_geng_visitor_project","t_gu_geng_vistor_statistic"});
