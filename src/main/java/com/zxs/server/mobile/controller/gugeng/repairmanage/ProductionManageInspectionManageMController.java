 ...
 */
@RestController
@RequestMapping(VALID_MOBILE_PATH+"/inspectionManage")
@Api(value = "巡检管理", tags = "巡检管理")
public class ProductionManageInspectionManageMController extends CommonUtil {
    ...
    public void export(ProductionManageInspectionManageListDTO listDTO, HttpServletResponse response) throws Exception {
        service.exportExcel(listDTO, getExportNumber(), "巡检管理", response);
    }
}
