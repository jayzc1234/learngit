...
@RestController
@RequestMapping(VALID_PATH+"/client")
@Api(tags = "客户管理")
public class ProductManageClientController extends CommonUtil {
	...
	public RestResult<ProductionManageClientDetailVO> detail(@RequestParam Long id) throws Exception {
		...
		ProductionManageClientDetailVO pClient = service.selectDetailById(id);
		restResult.setState(200);
		restResult.setResults(pClient);
		return restResult;
	}
	/**
	 * 客户列表
	...
	public RestResult<PageResults<List<ProductManageClientListVO>>> list(ProductManageClientListDTO clientListDTO)
		...
		PageResults<List<ProductManageClientListVO>> pageResults = service.page(clientListDTO);
		restResult.setState(200);
