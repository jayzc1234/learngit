...
public class GeneratorServiceEntityUtil {
    ...
    private static final String DB_URL = "jdbc:mysql://192.168.2.214:3306/hydra_bigdata_admin?characterEncoding=utf-8&useSSL=false";
    ...
    private static final String PACKAGE_NAME = "net.app315.hydra.bigdata.admin.server";
...
//    private static final String IS_DELETED = "is_deleted";
    ...
    public static void main(String[] args) throws SQLException {
        ...
        System.out.println("当前模块根路径为:" + new File("hydra-bigdata-admin").getAbsolutePath());
...
//        ArrayList<String> hydra_intelligent_planting = MySqlMetaData.getTableNameList("hydra_intelligent_planting");
        generateByTables("hydra-bigdata-admin-client","t_schema_columns_safety_rules");
