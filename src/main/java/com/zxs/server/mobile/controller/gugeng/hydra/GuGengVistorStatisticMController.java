package com.zxs.server.mobile.controller.gugeng.hydra;
 ...
 */
@RestController
@RequestMapping(VALID_MOBILE_PATH+"/mobile/visitor/statistic")
@Api(value = "运营统计-来访人员数据", tags = "运营统计-来访人员数据")
public class GuGengVistorStatisticMController {
    ...
    @GetMapping("/client")
    @ApiOperation(value = "来访客户类目", notes = "来访客户类目")
    @ApiImplicitParams({
