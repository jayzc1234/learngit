 ...
 */
@RestController
@RequestMapping(VALID_MOBILE_PATH+"/orderProductDataStatistics")
@Api(value = "销售产品数据", tags = "销售产品数据")
public class ProductionManageOrderProductDataStatisticsMController extends CommonUtil {

    @Autowired
    private ProductionManageOrderProductDataStatisticsService service;

    @GetMapping("/list")
    @ApiOperation(value = "列表", notes = "列表")
    @ApiImplicitParam(name = "super-token", paramType = "header", defaultValue = "64b379cd47c843458378f479a115c322", value = "token信息", required = true)
    public RestResult<AbstractPageService.PageResults<List<ProductionManageOrderProductDataStatisticsListVO>>> list(ProductionManageOrderProductDataStatisticsDTO statisticsDTO) throws SuperCodeException {
