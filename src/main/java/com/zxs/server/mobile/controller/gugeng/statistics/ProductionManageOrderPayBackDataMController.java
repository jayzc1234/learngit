 ...
 */
@RestController
@RequestMapping(VALID_MOBILE_PATH+"/saleProductData")
@Api(value = "订单回款数据", tags = "订单回款数据")
public class ProductionManageOrderPayBackDataMController extends CommonUtil {
    ...
    public void exportPayBackList(DateIntervalListDTO dateIntervalDTO, HttpServletResponse response) throws Exception {
        service.exportExcelReflect(dateIntervalDTO, getExportNumber(),"订单回款列表", ProductionManageOrderDataByTypeListVO.class,"pageList",response);
    }
    ...
    public void exportUnPaybackList(DateIntervalListDTO dateIntervalDTO, HttpServletResponse response) throws Exception {
        service.exportExcelReflect(dateIntervalDTO, getExportNumber(),"退货列表", ProductionManageOrderDataByTypeListVO.class,"unPaybackPageList",response);
    }
}
