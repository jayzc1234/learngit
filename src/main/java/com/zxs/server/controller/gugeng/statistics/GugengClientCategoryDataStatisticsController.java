 ...
 */
@RestController
@RequestMapping(VALID_PATH+"/order/clientCategory/")
@Api(value = "客户分类数据", tags = "客户分类数据")
public class GugengClientCategoryDataStatisticsController extends CommonUtil {
    ...
    public void export(ProductionManageOrderProductDataStatisticsDTO dateIntervalDTO, HttpServletResponse response) throws Exception {
        service.exportExcelList(dateIntervalDTO, getExportNumber(),"订单回款列表", GuGengOrderClientCategoryListVO.class,response);
    }
}
