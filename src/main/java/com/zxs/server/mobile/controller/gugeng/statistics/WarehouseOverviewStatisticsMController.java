...
@RestController
@RequestMapping(VALID_MOBILE_PATH+"/statistics/warehouseoverview")
@Api(tags = "仓储数据概览")
@Slf4j
public class WarehouseOverviewStatisticsMController {
    ...
    public RestResult<SearchHSLLineChartResponseVO> listHSLLineChart(String queryDate, String productId) throws Exception {
        CustomAssert.blank2Error(queryDate, "日期不可为空");
        ...
        overviewStatisticsService.listStockLoss(queryDate, responseVO);
